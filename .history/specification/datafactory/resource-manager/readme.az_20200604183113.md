...
directive:
    ...
    - from: swagger-document
      ...
      transform: >
          $['type'] = 'string'; 
    - from: $(this-folder)/specification/datafactory/resource-manager/Microsoft.DataFactory/stable/2018-06-01/entityTypes/LinkedService.json
      where: $.definitions.ScriptAction.properties.rules
      transform: >
          $['type'] = 'string'; 
    - where:
